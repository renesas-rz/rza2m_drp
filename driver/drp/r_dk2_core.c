...
#ifdef __KERNEL__
#define WR32(addr, data) *(volatile long *)((unsigned long)drpk_base_addr + ((addr) - 0xEA000000)) = (data)
#define WR64(addr, data) *(volatile long long *)((unsigned long)drpk_base_addr + ((addr) - 0xEA000000)) = (data)
#else
...
*******************************************************************************/
#ifdef __KERNEL__
extern void __iomem *drpk_base_addr;
#endif
...
uint32_t R_DK2_CORE_GetInt(void)
{
    ...
    dk2_get_int((unsigned long *)&dscc, (unsigned long *)&idif, (unsigned long *)&odif);
...
static void set_dma(unsigned int dma, int shift)
{
    volatile unsigned long idif_dmactli = (unsigned long)(drpk_base_addr + 0xFF9100);
    volatile unsigned long odif_dmactlo = (unsigned long)(drpk_base_addr + 0xFFA100);
