...
#ifdef __KERNEL__
/* DRP work areas must be non-cache access */
typedef uint8_t work_load_t[R_DK2_TILE_NUM][16];
typedef uint8_t work_start_t[R_DK2_TILE_NUM][32];
extern work_load_t *work_load_ptr;
extern work_start_t *work_start_ptr;
#define work_load (*work_load_ptr)
#define work_start (*work_start_ptr)
#else
#ifdef __GNUC__
...
#ifndef __KERNEL__ /* Function not used (avoid compiler warning) */
/*******************************************************************************
